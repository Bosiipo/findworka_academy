<nav class="navbar navbar-expand-md navbar bg-dark shadow-sm">
    <div class="container"> 
        ...
        <button class="navbar-toggler text-white" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
            <span class="navbar-toggler-icon bar1 d-block"></span>
            <span class="navbar-toggler-icon bar2 d-block"></span>
            <span class="navbar-toggler-icon bar3 d-block"></span>
        </button>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="text-decoration-none text-white nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
