...
@section('content')
    ...
    <div class="container m-5">
        ...
        <p class="lead">Course: Full-Stack Web Development</p>
        <p class="lead"><span>Amount: </span><span class="f_amount" style="display: none;">#300,000</span> <span class="i_amount" style="display: none;">#150,000</span></p>
