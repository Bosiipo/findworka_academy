...
@section('content')
    ...
    <div class="container m-5">
        ...
        <p class="lead">Course: Mobile Development</p>
        <p class="lead"><span>Amount: </span><span class="f_amount" style="display: none;">#200,000</span> <span class="i_amount" style="display: none;">#100,000</span></p>
