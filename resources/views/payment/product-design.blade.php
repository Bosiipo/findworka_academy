...
@section('content')
    ...
    <div class="container m-5">
        ...
        <p class="lead">Course: Product Design</p>
        <p class="lead"><span>Amount: </span><span class="f_amount" style="display: none;">#150,000</span> <span class="i_amount" style="display: none;">#75,000</span></p>
